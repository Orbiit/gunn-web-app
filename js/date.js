class DatePicker {
    ...
    constructor(start, end, elem) {
        ...
        var genesis = new Date(start.y, start.m, start.d), weeknum = 0,
            apocalypse = new Date(end.y, end.m, end.d).getTime(),
        ...
        this.dates.addEventListener("click", e => {
            if (e.target.classList.contains('datepicker-day') && e.target.dataset.notinrange !== 'true') this.day = {
                d: +e.target.dataset.date,
