...
// radios save format version
    ...
    normalschedule = [
        ...
        [
            ...
            {
                name: 'Brunch',
                start: {hour: 9, minute: 45, totalminutes: 585},
                end: {hour: 10, minute: 0, totalminutes: 600}
            },
            {
                name: 'B',
                start: {hour: 10, minute: 0, totalminutes: 600},
                end: {hour: 11, minute: 15, totalminutes: 675}
            },
            {
                name: 'C',
                start: {hour: 11, minute: 25, totalminutes: 685},
                end: {hour: 12, minute: 40, totalminutes: 760}
            },
            {
                name: 'Lunch',
                start: {hour: 12, minute: 40, totalminutes: 760},
                end: {hour: 13, minute: 20, totalminutes: 800}
            },
            {
                name: 'F',
                start: {hour: 13, minute: 20, totalminutes: 800},
                end: {hour: 14, minute: 35, totalminutes: 875}
            }
        ], [
            ...
            },
            {
                name: 'Flex',
                start: {hour: 10, minute: 0, totalminutes: 600},
                end: {hour: 10, minute: 50, totalminutes: 650}
            },
            {
                name: 'E',
                start: {hour: 11, minute: 0, totalminutes: 660},
                end: {hour: 12, minute: 15, totalminutes: 735}
            },
            {
                name: 'Lunch',
                start: {hour: 12, minute: 15, totalminutes: 735},
                end: {hour: 12, minute: 55, totalminutes: 775}
            },
            {
                name: 'A',
                start: {hour: 12, minute: 55, totalminutes: 775},
                end: {hour: 14, minute: 15, totalminutes: 855}
            },
            {
                name: 'G',
                start: {hour: 14, minute: 25, totalminutes: 865},
                end: {hour: 15, minute: 40, totalminutes: 940}
            }
        ], [
            {name: 'B', start: {hour: 8, minute: 25, totalminutes: 505}, end: {hour: 9, minute: 50, totalminutes: 590}},
            {
                name: 'Brunch',
                start: {hour: 9, minute: 50, totalminutes: 590},
                end: {hour: 10, minute: 5, totalminutes: 605}
            },
            {
                name: 'C',
                start: {hour: 10, minute: 5, totalminutes: 605},
                end: {hour: 11, minute: 25, totalminutes: 685}
            },
            {
                name: 'D',
                start: {hour: 11, minute: 35, totalminutes: 695},
                end: {hour: 12, minute: 55, totalminutes: 775}
            },
            {
                name: 'Lunch',
                start: {hour: 12, minute: 55, totalminutes: 775},
                end: {hour: 13, minute: 35, totalminutes: 815}
            },
            {
                name: 'F',
                start: {hour: 13, minute: 35, totalminutes: 815},
                end: {hour: 14, minute: 55, totalminutes: 895}
            },
        ], [
            ...
            },
            {
                name: 'Flex',
                start: {hour: 10, minute: 5, totalminutes: 605},
                end: {hour: 10, minute: 55, totalminutes: 655}
            },
            {
                name: 'B',
                start: {hour: 11, minute: 5, totalminutes: 665},
                end: {hour: 12, minute: 15, totalminutes: 735}
            },
            {
                name: 'Lunch',
            ...
            },
            {
                name: 'A',
                start: {hour: 12, minute: 55, totalminutes: 775},
                end: {hour: 14, minute: 5, totalminutes: 845}
            },
            {
                name: 'G',
                start: {hour: 14, minute: 15, totalminutes: 855},
                end: {hour: 15, minute: 35, totalminutes: 935}
            },
        ], [
            {name: 'C', start: {hour: 8, minute: 25, totalminutes: 505}, end: {hour: 9, minute: 40, totalminutes: 580}},
            {
                name: 'Brunch',
                start: {hour: 9, minute: 40, totalminutes: 580},
                end: {hour: 9, minute: 55, totalminutes: 595}
            },
            {name: 'D', start: {hour: 9, minute: 55, totalminutes: 595}, end: {hour: 11, minute: 5, totalminutes: 665}},
            {
                name: 'E',
                start: {hour: 11, minute: 15, totalminutes: 675},
                end: {hour: 12, minute: 25, totalminutes: 745}
            },
            {
                name: 'Lunch',
                start: {hour: 12, minute: 25, totalminutes: 745},
                end: {hour: 13, minute: 5, totalminutes: 785}
            },
            {
                name: 'F',
                start: {hour: 13, minute: 5, totalminutes: 785},
                end: {hour: 14, minute: 15, totalminutes: 855}
            },
            {
                name: 'G',
...
function initSchedule() {
    ...
    while (datepicker.compare({
        d: d.getDate(),
        m: d.getMonth(),
        y: d.getFullYear()
    }, datepicker.end) <= 0 && !isSchoolDay(d)) {
        d.setDate(d.getDate() + 1);
    }
