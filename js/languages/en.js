export default {
  html: {
    ...
    clubs: 'Clubs',
    'clubs-disclaimer':
      "Please note that club information was taken from the administration's {doc-link|chartered club list document} and {link|spreadsheet as of January 29th, 2020}, so attribute inaccuracies to them.",
