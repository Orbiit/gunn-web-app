...
JSON.stringify((() => {
const arr = [].concat(...Array.from(document.querySelectorAll('table > tbody'), table => {
...
const clubs = {}
for (const [[name, video], [zoom], [time], [presidentEmail], [signup]] of arr) {
const [president, email] = presidentEmail ? presidentEmail.split(/:\s*/) : []
